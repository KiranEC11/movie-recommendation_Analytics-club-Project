...
class Movie_recommender():
    def __init__(self):
        self.df_cleaned = pd.read_csv('E:/MTech/Academics/sem3/placements/self_projects/Movie_rec_club/Enter_movie_name/cleaned_data.csv')
        ...
        file_path = 'E:/MTech/Academics/sem3/placements/self_projects/Movie_rec_club/Enter_movie_name/linear_ker.pkl'
